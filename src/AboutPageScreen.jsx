...
<p>Meta's challenge piqued our interest due to our interest in current political topics. We were also eager for the opportunity to use react for Meta's challenge. The things react has done for development frameworks is an inspiration in itself. </p>
        <h3>What it does</h3>
<p>Our application takes in the URL of political news article and uses databases and other articles to try to determine if the article is biased to the best of our ability. We have three categories of bias: Left-Leaning, Right-Leaning, and Unbiased. When presented with your articles bias there will be three similarly biased articles. </p>
...
<p>We would like to implement machine learning to help better detect biases between articles. We would also like to add more computing power and storage to process more articles to check biases against. 
</p>
